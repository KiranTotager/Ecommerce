        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    DisplayHome = table.Column<bool>(type: "bit", nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    CValue = table.Column<string>(type: "nvarchar(max)", nullable: false),
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_CoupenDetails", x => x.CId);
                });
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_Staff_Categories_Rel", x => new { x.CategoriesId, x.StaffsId });
                    table.ForeignKey(
                        name: "FK_Staff_Categories_Rel_Categories_CategoriesId",
                        column: x => x.CategoriesId,
                        principalTable: "Categories",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_Staff_Categories_Rel_Staffs_StaffsId",
                        column: x => x.StaffsId,
            ...
            migrationBuilder.CreateTable(
                name: "Staff_CoupenDetails_Rel",
                columns: table => new
                {
                    CoupenDetailsCId = table.Column<int>(type: "int", nullable: false),
                    StaffsId = table.Column<Guid>(type: "uniqueidentifier", nullable: false)
                },
                constraints: table =>
                {
                    table.PrimaryKey("PK_Staff_CoupenDetails_Rel", x => new { x.CoupenDetailsCId, x.StaffsId });
                    table.ForeignKey(
                        name: "FK_Staff_CoupenDetails_Rel_CoupenDetails_CoupenDetailsCId",
                        column: x => x.CoupenDetailsCId,
                        principalTable: "CoupenDetails",
                        principalColumn: "CId",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_Staff_CoupenDetails_Rel_Staffs_StaffsId",
                        column: x => x.StaffsId,
                        principalTable: "Staffs",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        ...
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_CartItems_Guests_GuestId",
                        column: x => x.GuestId,
                        principalTable: "Guests",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_Staff_Products_Rel", x => new { x.ProductsProductId, x.StaffsId });
                    table.ForeignKey(
                        name: "FK_Staff_Products_Rel_Products_ProductsProductId",
                        column: x => x.ProductsProductId,
                        principalTable: "Products",
                        principalColumn: "ProductId",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_Staff_Products_Rel_Staffs_StaffsId",
                        column: x => x.StaffsId,
                        principalTable: "Staffs",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Staff_Categories_Rel_StaffsId",
                table: "Staff_Categories_Rel",
                column: "StaffsId");

            migrationBuilder.CreateIndex(
                name: "IX_Staff_CoupenDetails_Rel_StaffsId",
                table: "Staff_CoupenDetails_Rel",
                column: "StaffsId");

            migrationBuilder.CreateIndex(
                name: "IX_Staff_Products_Rel_StaffsId",
                table: "Staff_Products_Rel",
                column: "StaffsId");
